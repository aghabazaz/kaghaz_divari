...
class codeService extends \f\service
{
    ...
    public function getActionsByFilterType()
    {
        return \f\ttt::dal('core.code.getActionByFilterType',
                           array (
                    'filterType' => $this->request->getParam('filterType')
                )) ;
    }
    ...
    public function getAllRunnableCodes()
    {
        ...
        $tierHierarchiScanner = new tierHierarchiScanner($mode) ;
        ...
        $UICombined = $tierHierarchiScanner->scanTierRecursive('ui', $UIDocs) ;
...
//        return 'a';
    ...
    public function translateRequest()
    {
        ...
        switch ( $this->request->getParam('requestType') )
        {
            ...
            case 'ui.frontend':
                $uiObj      = new ui ;
                return $uiObj->translateFrontendRequest($urlParts) ;
        }
    }
    ...
    public function removeMethodDocument()
    {
        ...
        $result = \f\ttt::dal('core.code.removeMethodDocument',
                              $this->request->getAssocParams()) ;
        if ( $result )
        {
            return array ( 'success', \f\ifm::t('successRemove') ) ;
        }
        else
        {
    ...
    {
        $result = \f\ttt::dal('core.code.removeComponentDocument',
                              $this->request->getAssocParams()) ;
        if ( $result )
        {
            return array ( 'success', \f\ifm::t('successRemove') ) ;
