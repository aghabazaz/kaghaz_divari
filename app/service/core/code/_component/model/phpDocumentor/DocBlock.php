...
class DocBlock implements \Reflector
{
    ...
    protected function parseTags ( $tags )
    {
        ...
        if ( '' !== $tags )
        {
            ...
            {
                $result[ $key ] = Tag::createInstance ( trim ( $tag_line ),
                                                               $this ) ;
            }
        }
...
spl_autoload_register ( function($className)
        {
            ...
            if ( $classNameParts[ 0 ] == 'phpDocumentor' )
            {
                unset ( $classNameParts[ 0 ] ) ;
            }
            if ( isset ( $classNameParts[ 1 ] ) )
            {
                if ( $classNameParts[ 1 ] == 'Reflection' )
                {
            ...
            $pathToClassFile = implode ( \f\DS, $classNameParts ) . '.php' ;

            if ( file_exists ( __DIR__ . \f\DS . $pathToClassFile ) )
            {
