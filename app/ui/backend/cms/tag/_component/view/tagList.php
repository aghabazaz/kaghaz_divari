...
echo $pageWidget->renderTitle ( array ( 'title' => \f\ifm::t ( 'tag' ), 'links' => array ( array ( 'title'    => '+ ' . \f\ifm::t ( 'addtag' ), 'href'     => \f\ifm::app ()->baseUrl . 'cms/tag/tagAdd/' . $param ) ) ) ) ;
...
<script>
    $(document).ready(function () {
        ...
        widgetHelper.makeDataTable('#myTable' , newOption , '<?= \f\ifm::app ()->baseUrl ?>cms/tag/tagList');
