...
class testLogic extends \f\view
{
    ...
    public function renderSetting ( $param )
    {
        ...
        if ( $param[ 'pl_id' ] || $param[ 'upl_id' ] || $param[ 'urpl_id' ])
        {
            ...
            {
                $param[ 'params' ] = array ( 'URPL_ID'   => $param[ 'urpl_id' ], 'userid'   => $param[ 'userid' ], 'urlogicid' => $param[ 'logicID' ] ) ;
            }
