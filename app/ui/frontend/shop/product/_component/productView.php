...
class productView extends \f\view
{
    ...
    //برای نمایش صفحه جزئیات محصول در فرانت
    public function renderGetProductDetail($params)
    {
        $id = $params[0];
        //یکی به تعداد بازدید محصول اضافه می کند
        ...
        //در صورتی که محصول جزء محصولات با تخفیف ویژه است
        ...
        //گرفتن اطلاعات دسته بندی مرتبط با محصول
        ...
        $parentsCat = $this->sortByCatIdBreadcrumbs($catId, $sort_category);
        ...
        //دریافت امتیازات مرتبط با محصول
        ...
        //گرفتن موجودی محصولی که به عنوان هدیه مشخص شده است اگر موجودی این محصول کمتر از تعدادی باشد که می خواهیم هدیه بدهیم امکان هدیه دادن محصول وجود ندارد
        $stockProductGift=\f\ttt::dal('shop.product.getStockOfGift',$row);

        //برای نمایش محصولاتی که در دسته بندی داینامیک قرار دارند و تصویر محصولات را می توان برش داد و یا تغییر اندازه و یا تغییر رنگ داد
        if($catId['dynamic']=='true'){

            //نوع جنسهای مربوط به محصول گرفته می شود
            ...
            //قیمت های مختلف محصول گرفته می شود که در این مورد از محصولات قیمت بر حسب مترمربع محاسبه می شود
            ...
            //برای نمایش محصولاتی که تصویر آنها به صورت ثابت است
    ...
    public function renderCustomRequestIndex(){
        //نوع جنسهای مربوط به محصول گرفته می شود
        $material= \f\ttt::service('shop.material.getMaterial');
        //\f\pre($material);
        //$materialArray=array_column($material,'name','id');
        //\f\pre($material);
        return $this->render('customReq',array('material'=>$material)) ;
    }
    //ok
    ...
    public function renderGetSpecialCategory(){
        ...
        $row           = \f\ttt::dal('shop.category.getCategorySpecial', true );
