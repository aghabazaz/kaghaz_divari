                        ...
                        <div class="product-inner">
                            <div class="product-thumb style2">
                                <div class="thumb-inner">
                                    <a href="<?= \f\ifm::app()->siteUrl . 'productDetail/' . $data['productId'].'/'.$data['title'] ?>" title="<?=$data['title']?>">
                            ...
                            <div class="product-innfo">
                                <div class="product-name">
                                    <a href="<?= \f\ifm::app()->siteUrl . 'productDetail/' . $data['productId'].'/'.$data['title'] ?>" title="<?=$data['title']?>"> <?= $data['title'] ?></a>
                                </div>
                                <span class="price">
                        <?php
                        ...
                        ?>
                                ...
                                <div>
                                    <div class="inner">
                                        ...
                                        <a class="btn-add-to-cart" href="<?= \f\ifm::app ()->siteUrl . 'productDetail/' . $data[ 'productId' ].'/'.$data['title'] ?>" data-type="<?=($data['dynamic']=='true'?'dynamic':'static')?>" title="افزودن به سبد خرید"> &nbsp;جزئیات محصول</a>
                                    </div>
                                </div>
                            </div>
                        </div>
