...
if ( $page > 1 )
{
    echo '<a style="float:right" href="' . $href . '/page/' . $pr . '">صفحه قبلی</a>' ;
}
else
{
    echo '<a style="float:right" class="disabled" href="javascript:void(0)">صفحه قبلی</a>' ;
}
...
if ( $page < $counter - 1 )
{
    echo '<a style="float:left;display:inline-block" href="' . $href . '/page/' . $nx . '"  >صفحه قبلی</a>' ;
}
else
{
    echo '<a style="float:left;display:inline-block" href="javascript:void(0)"  >صفحه بعدی</a>' ;
}
