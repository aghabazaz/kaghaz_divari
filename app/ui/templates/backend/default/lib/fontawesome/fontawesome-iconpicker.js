(function(a, b) {
    ...
    a.fn.pos = function(b) {
        ...
        return this.each(function() {
            var g, h, i = a(this), j = i.outerWidth(), l = i.outerHeight(), o = n(this, "marginRight"), s = n(this, "marginTop"), y = j + o + n(this, "marginLeft") + v.width, z = l + s + n(this, "marginBottom") + v.height, A = a.extend({}, r), B = m(x.my, i.outerWidth(), i.outerHeight());
            if (b.my[0] === "right") {
                A.right -= j;
            ...
            if (b.using) {
                h = function(a) {
                    var c = q.right - A.right, f = c + k - j, g = q.top - A.top, h = g + p - l, m = {
                        target: {
                            element: t,
                            right: q.right,
                            top: q.top,
                        ...
                        horizontal: f < 0 ? "right" : c > 0 ? "left" : "center",
    ...
    a.ui.pos = {
        ...
        fit: {
            right: function(b, c) {
                a.ui.pos._trigger(b, c, "posCollide", "fitRight");
                var e = c.within, f = e.isWindow ? e.scrollRight : e.offset.right, g = e.width, h = b.right - c.collisionPosition.marginRight, i = f - h, j = h + c.collisionWidth - g - f, k;
                if (c.collisionWidth > g) {
                    if (i > 0 && j <= 0) {
                        k = b.right + i + c.collisionWidth - g - f;
                        b.right += i - k;
                    } else if (j > 0 && i <= 0) {
                        b.right = f;
                    } else {
                        if (i > j) {
                            b.right = f + g - c.collisionWidth;
                        } else {
                            b.right = f;
                        }
                    }
                    ...
                    b.right = d(b.right - h, b.right);
                }
                a.ui.pos._trigger(b, c, "posCollided", "fitRight");
            },
            top: function(b, c) {
...
(function(a) {
    ...
    c.defaultOptions = {
        ...
        templates: {
            ...
            search: '<input type="search" class="form-control iconpicker-search" placeholder="جستجو ..." />',
