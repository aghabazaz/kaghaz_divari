...
$(document).ready(function() {
    ...
    $(".check_all").click(function() {
        $("form:parent").find(':checkbox').each(function() {
            if ($(this).attr('class') != 'check_all') $(this).attr('checked', !$(this).attr('checked'))
        })
    });
    (function($) {
    ...
    setTimeout(function() {
        $(".auto_hide").slideUp('slow', function() {
            $(".auto_hide").remove()
        })
    }, 10000);
    $.ajaxSetup({
...
var confirm_message = 'مطمئن هستید؟';
var loaders = 0;
...
function confirmIt(message) {
    if (!message) message = confirm_message;
...
function loading(set) {
    if (set == 1) $('#loading').show();
    else if (set == 0) $('#loading').hide()
}
...
"function" != typeof Object.create && (Object.create = function(a) {
    ...
    function(a, b, c, d) {
        var e = {
            init: function(b, c) {
                var d = this;
                d.$elem = a(c), d.options = a.extend({}, a.fn.owlCarouselDet.options, d.$elem.data(), b), d.userOptions = b, d.loadContent()
            },
            loadContent: function() {
                ...
                var b = this;
                if ("function" == typeof b.options.beforeInit && b.options.beforeInit.apply(this, [b.$elem]), "string" == typeof b.options.jsonPath) {
            ...
            doTranslate: function(a) {
                var b = this;
                return a = "rtl" == b.options.direction ? -a : a, {
            ...
            checkBrowser: function() {
                ...
                var f = /translate3d\(0px, 0px, 0px\)/g,
                    ...
                    h = null !== g && g.length >= 1 && g.length <= 2,
            ...
            gestures: function() {
                ...
                function h(b) {
                    "on" === b ? (a(c).on(e.ev_types.move, j), a(c).on(e.ev_types.end, k)) : "off" === b && (a(c).off(e.ev_types.move), a(c).off(e.ev_types.end))
                }
                ...
                function i(c) {
                    ...
                    if (!(e.itemsAmount <= e.options.items)) {
                        ...
                        e.options.autoPlay !== !1 && clearInterval(e.autoPlayInterval), e.browser.isTouch === !0 || e.$owlWrapper.hasClass("grabbing") || e.$owlWrapper.addClass("grabbing"), e.newPosX = 0, e.newRelativeX = 0, a(this).css(e.removeTransition());
                ...
                function k(c) {
                    var c = c.originalEvent || c || b.event;
                    if (c.target = c.target || c.srcElement, f.dragging = !1, e.browser.isTouch !== !0 && e.$owlWrapper.removeClass("grabbing"), "rtl" == e.options.direction ? e.newRelativeX < 0 ? e.dragDirection = e.owl.dragDirection = "right" : e.dragDirection = e.owl.dragDirection = "left" : e.newRelativeX < 0 ? e.dragDirection = e.owl.dragDirection = "left" : e.dragDirection = e.owl.dragDirection = "right", 0 !== e.newRelativeX) {
                ...
                for (var c = 0; c < b.itemsAmount; c++) {
                    ...
                    if ("loaded" !== e.data("owl-loaded")) {
                        var h, f = e.data("owl-item"),
                            g = e.find(".lazyOwl");
                        "string" == typeof g.data("src") ? (e.data("owl-loaded") === d && (g.hide(), e.addClass("loading").data("owl-loaded", "checked")), h = b.options.lazyFollow !== !0 || f >= b.currentItem, h && f < b.currentItem + b.options.items && g.length && b.lazyPreload(e, g)) : e.data("owl-loaded", "loaded")
                    }
                }
            },
            ...
            singleItemTransition: function() {
                function h(b, c) {
                    return "rtl" == a.options.direction ? {
                        position: "relative",
                        right: b + "px"
                    } : {
                        position: "relative",
            ...
            removeItem: function(a) {
                var c, b = this;
                return 0 !== b.$elem.children().length && (c = a === d || a === -1 ? -1 : a, b.unWrap(), b.$userItems.eq(c).remove(), void b.setVars())
            }
        };
        a.fn.owlCarouselDet = function(b) {
            return this.each(function() {
                if (a(this).data("owl-init") === !0) return !1;
                a(this).data("owl-init", !0);
                var c = Object.create(e);
                c.init(b, this), a.data(this, "owlCarouselDet", c)
            })
        }, a.fn.owlCarouselDet.options = {
            direction: "ltr",
            items: 5,
            itemsCustom: !1,
            itemsDesktop: [1199, 4],
