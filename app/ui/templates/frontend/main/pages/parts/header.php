...
if ( $menu != '404' )
{
    ...
    \f\ttt::service( 'shop.order.removeExpireCart',[],true );

//    $this->registerGadgets(array('detectG'=>'mobileDetect'));
//    
//    if($this->detectG->isMobile())
//    {
//        \f\pre('mobile');
//    }
...
<head>
    ...
    <!-- styles -->
    <!--
        <link rel="stylesheet" type="text/css" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/base/css/bootstrap.css">
        <link rel="stylesheet" type="text/css" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/font-awesome.css">
        <link rel="stylesheet" type="text/css" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/owl.carousel.css">
        <link rel="stylesheet" type="text/css" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/vit-gallery.css">
        <link rel="stylesheet" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/base/js/select/select2.css">
        <link rel="stylesheet" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/slider.css" type="text/css" media="screen">
        <link rel="stylesheet" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/slick.css" type="text/css" media="screen">
        <link rel="stylesheet" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/slick-theme.css" type="text/css" media="screen">
        <link rel="stylesheet" type="text/css" href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/base/css/style.css">
        -->
    <link rel="stylesheet" type="text/css"
          href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/app.min.css">
    <link rel="stylesheet" type="text/css"
          href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/styles.min.css">
    <!--
    <link rel="stylesheet" type="text/css"
          href="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/css/color-pink.css">
    ...
    <script type="text/javascript"
            src="<?= \f\ifm::app()->siteUrl ?>app/ui/templates/frontend/main/js/jquery.min.js"></script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-111210117-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-111210117-1');
</script>
    ...
    <section layout="row" flex >
            ...
            <md-sidenav class="md-sidenav-right" md-component-id="right" md-whiteframe="3" >
                <div class="header-menu-mobile">
                    <img src="<?= \f\ifm::app()->fileBaseUrl . '849' ?>"
                </div>
...
<div class="mobile-view">
    <div class="loading-main">
        <div style="text-align: center;padding-top: 40%">
            <img src="<?= \f\ifm::app()->siteUrl . $websiteInfo['logo_url'] ?>" style="max-height: 60px" alt="پخش لوازم جانبی موبایل">
        </div>
                ...
                <div class="sticky-container">
                    ...
                    <div class="grid-row" style="direction: rtl">
                        <section id="logo" class="logo">
                            <div>
                                <a href="<?= \f\ifm::app()->siteUrl ?>"><img src="<?= \f\ifm::app()->siteUrl . $websiteInfo['logo_url'] ?>"
                                                                             alt="<?= $websiteInfo['title'] ?>"></a>
                            </div>
                        </section>
                                    ...
                                    <ul class="dropdown-menu account-menu">
                                        ...
                                        ?>
                                            ...
                                            <li>
                                                ...
                                                <a href="<?= \f\ifm::app()->siteUrl . 'register' ?>">ثبت نام</a>
                                            </li>
                                            <?php
                                        }
                                        ?>
    ...
    <div class="mobile-view">
        <div class="mobile-header">
            ...
            <div class="action-mobile">
                ...
                <a href="<?= \f\ifm::app()->siteUrl . 'cart' ?>" class="cart-mobile">
