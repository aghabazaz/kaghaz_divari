...
<p>
    ...
    <span style="color:red">
        <?=   $order[ 'discount' ]?number_format ( $order[ 'discount' ] ) . ' ریال ':'---' ; ?>
    </span>
</p>
<p>
    <span>
    ...
    <span style="color:red">
        <?=  $discountCodePrice?number_format ( $discountCodePrice ) . ' ریال ':'---' ; ?>
    </span>
</p>
<p>
    <span>
    ...
    <span style="color:green">
        <?= number_format ( $order[ 'transportation_cost' ] ) . ' ریال ' ; ?>
    </span>
</p>
<p>
    <span>
    ...
    <span>
        <?= number_format ( ($order[ 'price' ] - $order[ 'discount' ] - $discountCodePrice) + $order[ 'transportation_cost' ] ) . ' ریال ' ; ?>
    </span>
</p>
<?php
echo \f\html::markupEnd ( 'div' ) ;
...
<p>
    ...
    <span>
        <?= $order[ 'price_pay' ]?number_format ( $order[ 'price_pay' ] ) . ' ریال ':'---' ; ?>
    </span>
</p>
<?php
echo \f\html::markupEnd ( 'div' ) ;
    ...
    <div class="col-md-12 container-cart">
        ...
        <div class="col-md-2  padding-0-col">
            ...
            foreach ( $orderItem AS $data )
            {
                ...
                <div class="tbody border">
                    <div class="pd" >
                        <span class="unitprice" style="position:relative;top: 40%;" id="unitprice_<?= $data[ 'orderItem_id' ] ?>"><?= number_format ( $data[ 'price' ] ) ?></span><span class="toman" style="position:relative;top: 40%;">ریال</span>
                    </div>
                </div>
                <?php
            }
