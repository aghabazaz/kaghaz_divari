...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listCity' ),
            'href'  => \f\ifm::app ()->baseUrl . 'cms/place/city/index' ) ) ) ) ;
...
$form.=$this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'cms/place/city/citySave',
        'id'     => 'cityAdd'
    ),
        ) ) ;
...
<script>
    ...
    widgetHelper.formSubmit('#cityAdd');
</script>
