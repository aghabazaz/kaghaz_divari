<?php
$title = $row ? 'editguarantee' : 'addguarantee' ;
...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listguarantee' ),
            'href'  => \f\ifm::app ()->baseUrl . 'shop/guarantee/index' ) ) ) ) ;
...
$form.=$this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'shop/guarantee/guaranteeSave',
        'id'     => 'color_Add'
    ),
        ) ) ;
