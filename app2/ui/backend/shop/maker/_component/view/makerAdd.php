...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listmaker' ),
            'href'  => \f\ifm::app ()->baseUrl . 'shop/maker/index' ) ) ) ) ;
...
$form.=$this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'shop/maker/makerSave',
        'id'     => 'makerAdd'
    ),
        ) ) ;
...
$form.=$this->formW->buttonTag ( array (
    ...
    'action' => array (
        ...
        'params'  => array (
            ...
            'triggerElement' => 'selectMakerLogo', //chanage
            'containerId'    => '#fileContainer3',
            'urlParams'      => array (
                'path'        => 'shop.maker' //chanage
            ),
...
<script>
    ...
    widgetHelper.formSubmit('#makerAdd');
