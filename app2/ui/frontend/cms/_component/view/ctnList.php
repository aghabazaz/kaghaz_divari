    ...
    <div class="post-item">
        <div class="post-thumb">
            <a href="<?= \f\ifm::app()->siteUrl . 'contentDetail/' . $data['id'].'/'.$data['title'] ?>" title="<?= $data['title'] ?>">
                <img  src="<?= \f\ifm::app()->fileBaseUrl . $data['picture']; ?>" title="<?= $data['title'] ?>" alt="<?= $data['title'] ?>"></a>
        </div>
        ...
        <h3 class="post-name"><a
                    href="<?= \f\ifm::app()->siteUrl . 'contentDetail/' . $data['id'].'/'.$data['title'] ?>" title="<?= $data['title'] ?>"><?=$data['title']?></a></h3>
        <div class="post-item-info">
            <a href="<?= \f\ifm::app()->siteUrl . 'contentDetail/' . $data['id'].'/'.$data['title'] ?>" class="read-more-homepage" title="<?=$data['title']?>">جزئیات
                بیشتر</a>
        </div>
    </div>
    <?php
