<section class="page-title">
    <div class="grid-row clearfix">
        ...
        <nav class="bread-crumbs">
            ...
            {
                ?>
                <a href="<?= \f\ifm::app ()->siteUrl ?>news/"><?= 'اخبار و اطلاعیه ها' ?></a>
                &nbsp;&nbsp;<i class="fa fa-angle-left"></i>&nbsp;
                <a href="<?= \f\ifm::app ()->siteUrl ?>news/<?= $sRow[ 'id' ] ?>"><?= $sRow[ 'title' ] ?></a>
    ...
    <div class="grid-row">
        <section class="widget news news-1" id="news">						
            <div class="grid isotope" >
                    ...
                    foreach ( $row AS $data )
                    {
                        ...
                        <div class="item isotope-item" >
                            <h3 class="widget-title">
                                <a href="<?= \f\ifm::app ()->siteUrl . 'newsDetail/' . $data[ 'id' ] ?>"> <?= $data[ 'title' ] ?></a>
                            </h3>
                            <div class="date">
                                <?php
                            ...
                            <div class="wrapper">
                                <div class="pic">
                                    ...
                                    <div class="links">
                                        <ul>
                                            <li><a class="fa fa-eye" href="<?= \f\ifm::app ()->siteUrl . 'newsDetail/' . $data[ 'id' ] ?>"></a></li>										
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                {
                    echo 'هیچ خبری در سایت درج نشده است.' ;
                }
                ?>
        ...
        <div class="pagination" style="text-align: center">
            ...
            if ( $sRow[ 'id' ] )
            {
                $href = \f\ifm::app ()->siteUrl . 'news/' . $sRow[ 'id' ] ;
            }
            else
            {
