 ...
 <div class='col-md-3'>
            ...
            if ( $val2[ 'data' ][ 'show_title' ] == 'enabled' )
            {
                if ( $val2[ 'data' ][ 'type' ] == 'link' )
                {
                    ...
                    {
                        $param.="
                                    <h6 class='dropdown-menu-title'><a title='".$val2[ 'data' ][ 'title' ]."' href='" . $val2[ 'data' ][ 'link' ] . "'  >" . $icon . ' ' . $val2[ 'data' ][ 'title' ] . "</a></h6>
                            " ;
                    }
                    else
                    {
                        ...
                        $param.="
                                   <h6 class='dropdown-menu-title'><a href='".$link. "' >" . $icon . ' ' . $val2[ 'data' ][ 'title' ] . "</a></h6>
                            " ;
                    }
                }
                else
