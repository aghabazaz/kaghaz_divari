...
<main class="site-main">
    ...
    echo \f\ttt::block( 'shop.product.getSpecialCategory' );
    ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="block-blog blog-home hide-mobile">
                    ...
                    <div class="owl-carousel nav-style2" data-nav="true" data-autoplay="true" data-dots="false" data-loop="true" data-margin="30" data-responsive='{"0":{"items":2},"480":{"items":3},"768":{"items":3},"1200":{"items":1}}'>
                        <?php
