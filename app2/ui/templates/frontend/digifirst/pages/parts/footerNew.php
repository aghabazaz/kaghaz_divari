...
<script type="text/javascript" defer="defer" src="<?= \f\ifm::app ()->siteUrl ?>app/ui/templates/frontend/digifirst/js/scripts.js"></script>
...
<script>
    ...
    function plusItem(item) {
        ...
        //console.log($(item).parent().find('#dynamic').val());
        //console.log(topItem);
        var option = {
            product_price_id: tabdil($(item).parent().find('#product_price_id').val()),
            product_id: tabdil($(item).parent().find('#product_id').val()),
            typeOpr:'increase',
            count:tabdil(count),
            topItem:topItem,
            typeProduct:$(item).parent().find('#dynamic').val(),
    ...
    function getBasketSidebar(params='null') {
       // console.log(params.topItem);
        ...
        }else if(params.result=='errorOnProductDetails'){
            window.location.href = '<?= \f\ifm::app()->siteUrl ?>productDetail/'+params.productId;
        }else {
            window.location.href = '<?= \f\ifm::app()->siteUrl ?>productDetail/'+params.productId;
        }
    }
    ...
    function sendAddToCart(id,product_price_id,item) {
      ...
      /*  topPos=$(item).parent().parent().parent().offset().top;
        ...
        var option = {
            ...
            price:tabdil($(item).parent().parent().parent().find('.price ins').text()),
            data_type:data_type,
            //:$(item).parent().parent().parent().find('#itemPriceVal').text()
        };
        widgetHelper.tt('ui', 'shop.product.sendAddToCart', option, 'getBasketSidebar');
    }
