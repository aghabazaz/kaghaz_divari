...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listreturned' ),
            'href'  => \f\ifm::app ()->baseUrl . 'accountingStock/returned/index' ) ) ) ) ;
...
//                              array (
//            'htmlOptions' => array (
//                'href' => \f\ifm::app ()->baseUrl . "returnedStock/returned/returnedEdit/" . $orderItem[ 'id' ],
//    ) ) ) ;
...
<p>
    ...
    <span>
        <?= number_format ( ($order[ 'price' ] - $order[ 'discount' ] - $order[ 'discount_price' ]) + $order[ 'transportation_cost' ] ) . ' تومان ' ; ?>
    </span>
</p>
<p>
    <span>
    ...
    <span>
        <?= number_format ( $order[ 'price_pay' ] ) . ' تومان ' ; ?>
    </span>
</p>
<?php
echo \f\html::markupEnd ( 'div' ) ;
