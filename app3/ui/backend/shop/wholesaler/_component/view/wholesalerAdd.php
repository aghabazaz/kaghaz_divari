<?php
$title = $row ? 'editwholesaler' : 'addwholesaler' ;
...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listwholesaler' ),
            'href'  => \f\ifm::app ()->baseUrl . 'shop/wholesaler/index' ) ) ) ) ;
...
$form.=$this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'shop/wholesaler/wholesalerSave',
        'id'     => 'wholesalerAdd'
    ),
        ) ) ;
...
<script>
    ...
    widgetHelper.formSubmit('#wholesalerAdd');
