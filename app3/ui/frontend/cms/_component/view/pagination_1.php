...
{
    echo '<a class="disabled" href="javascript:void(0)">صفحه قبلی</a>' ;
}
echo '<ul>' ;
//---------------------------------------------------------------------------------------------------
if ( $lastpage < 7 + ($adjacents * 2) )
{
    ...
    {
        if ( $counter == $page )
                echo '<li class="current"><a href="javascript:void(0)"  >', $counter, '</a></li>' ;
        else
                echo '<li><a href="' . $href . '/page/' . $counter . '"  >', $counter, '</a></li>' ;
    }
}
...
{
    echo '<a href="javascript:void(0)"  >صفحه بعدی</a>' ;
}
