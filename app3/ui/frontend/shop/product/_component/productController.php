...
//\f\pre($content);
    ...
    public function sendAddToCart ()
    {
        ...
        if($params['typeProduct']=='dynamic' and ($params['typeOpr']!='increase' or $params['typeOpr']!='decrease')){
    ...
    public function sendCustomProductRequest(){
        $params = $this->request->getAssocParams () ;
        $row                 = \f\ttt::service ( 'shop.customProductRequest.sendCustomProductRequest',$params ) ;
        return $this->response ( $row ) ;
        //\f\pre($params);
    }
}
