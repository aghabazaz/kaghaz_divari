...
!function (d) {
    var h = function (a) {
        this.messages = {defaultMessage: "مقدار وارد شده نامعتبر می باشد.", type: {email: "فرمت ایمیل وارد شده نامعتبر می باشد.", url: "آدرس اینترنتی وارد شده نامعتبر می باشد.", urlstrict: "آدرس اینترنتی وارد شده نامعتبر می باشد.", number: "مقدار وارد شده باید به صورت یک عدد معتبر باشد.", digits: "مقدار وارد شده باید به صورت عددی باشد.", dateIso: "فرمت تاریخ وارد شده نامعتبر است.", alphanum: "مقدار وارد شده باید به صورت حروف باشد.", phone: "فرمت شماره تلفن وارد شده نامعتبر می باشد."}, notnull: "مقدار وارد شده نباید Null باشد.",
            notblank: "این فیلد نمی تواند خالی باشد.", required: "پر کردن این فیلد الزامی است.", regexp: "مقدار وارد شده نامعتبر می باشد.", min: "مقدار وارد شده باید برزگتر مساوی %s باشد.", max: "مقدار وارد شده باید کوچکتر مساوی %s باشد.", range: "مقدار وارد شده باید بین %s و %s  باشد.", minlength: "تعداد کاراکترهای وارد شده باید بیشتر مساوی %s کاراکتر باشد.", maxlength: "طول مقدار وارد شده باید کمتر مساوی %s کاراکتر باشد.", rangelength: "طول مقدار وارد شده باید بین %s تا %s کاراکتر باشد.",
            mincheck: "انتخاب حداقل %s گزینه الزامی است.", maxcheck: "تعداد انتخاب ها نباید بیشتر از %s گزینه باشد.", rangecheck: "تعداد انتخاب ها باید بین %s تا %s گزینه باشد.", equalto: "This value should be the same."};
        this.init(a)
    };
    h.prototype = {constructor: h, validators: {notnull: function () {
                ...
                return{validate: function (a, b, c) {
                        ...
                        var g = function (a, b) {
                            ...
                            if (!1 === a)
                                c.options.listeners.onFieldError(c.element, c.constraints, c);
                            else
                                !0 === a &&
            ...
            if ("undefined" === typeof b().validate)
                throw Error("Validator `" + a + "` must have a validate method. See more here: http://parsleyjs.org/documentation.html#javascript-general");
    ...
    n.prototype = {constructor: n, init: function (a) {
            ...
            if (!("required" === a.name && null !== this.ParsleyInstance.getVal() && 0 < this.ParsleyInstance.getVal().length))
                if (this.ParsleyInstance.isRequired && "required" !== a.name && (null === this.ParsleyInstance.getVal() || 0 === this.ParsleyInstance.getVal().length))
                    this.removeError(a.name);
                else {
    ...
    m.prototype = {constructor: m,
        ...
        bindHtml5Constraints: function () {
            ...
            for (var d in a)
                d = d.toLowerCase(), "function" === typeof this.Validator.validators[d] && (this.constraints[d] = {name: d, requirements: a[d], valid: null},
            ...
            if (!1 === a)
                ...
                !0 === a && !1 === this.options.listeners.onFieldSuccess(this.element, this.constraints, this) && (a = !1);
            return a
        }, manageValidationResult: function () {
            var a = null, b = [], c;
            for (c in this.constraints)
                !1 === this.constraints[c].valid ? (b.push(this.constraints[c]), a = !1) : !0 === this.constraints[c].valid && (this.UI.removeError(this.constraints[c].name), a = !1 !== a);
            this.valid = a;
            if (!0 === this.valid)
            ...
            if (!1 === this.valid) {
                if (!0 === this.options.priorityEnabled) {
                    for (var a = 0, e, f = 0; f < b.length; f++)
                        e = this.Validator.validators[b[f].name]().priority, e > a && (c = b[f], a = e);
                    this.UI.manageError(c)
                } else
                    for (f = 0; f < b.length; f++)
                        this.UI.manageError(b[f]);
    ...
    q.prototype = {constructor: q, init: function (a, b, c) {
            ...
            for (var b = 0; b < this.items.length; b++)
                if (this.items[b].hash === a.hash)
                    return this.items[b].destroy(), this.items.splice(b,
                            1), !0;
            return!1
        }, validate: function (a) {
            var b = !0;
    ...
    d.fn.domApi = function (a) {
        ...
        for (var f in this[0].attributes)
            if (b = this[0].attributes[f], null !== b && b.specified && e.test(b.name)) {
    ...
    d.fn.parsley.defaults =
            {namespace: "parsley-", inputs: "input, textarea, select", excluded: "input[type=hidden], input[type=file], :disabled", priorityEnabled: !0, trigger: !1, animate: !0, animateDuration: 300, scrollDuration: 500, focus: "first", validationMinlength: 3, successClass: "parsley-success", errorClass: "parsley-error", errorMessage: !1, validators: {}, showErrors: !0, messages: {}, validateIfUnchanged: !1, errors: {classHandler: function (a, b) {
                    ...
                    }, errorsWrapper: "<ul></ul>", errorElem: "<li></li>"}, listeners: {onFieldValidate: function (a,
                            b) {
                        return!1
