...
class executiveService extends \f\service
{
    ...
    public function checkPermission()
    {
        ...
        return 'Authorization_Failed' ; # permission denied
    }
    ...
    public function cachePermissions()
    {
        ...
        {
            \f\ttt::dal('core.rbac.executive.cacheAllActions',
                        array (
                'userId' => $userId
            )) ;
        }
        ...
        {
            \f\ttt::dal('core.rbac.executive.cacheMyPermissions',
                        array (
                'userId' => $userId
            )) ;
        }
