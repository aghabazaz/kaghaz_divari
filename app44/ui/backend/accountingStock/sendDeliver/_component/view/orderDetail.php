...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listsendDeliver' ),
            'href'  => \f\ifm::app ()->baseUrl . 'accountingStock/sendDeliver/index' ) ) ) ) ;
...
<p>
    ...
    <span>
        <?= $order[ 'price_pay' ]?number_format ( $order[ 'price_pay' ] ) . ' تومان ':( $order[ 'pos_option' ]=='pos'? 'پرداخت در محل دستگاه کارت خوان':' پرداخت در محل نقدی') ; ?>
    </span>
</p>
                ...
                <div class="tbody border">
                    <div class="pd" >
                        <p style="position:relative;top: 30%;">
                            ...
                            <span class="toman" style="position:relative;top: 40%;">ریال</span>
                        </p>
                        ...
                        <p style="position:relative;top: 30%" > 
                            <span class="unitprice green span_price_cart" id="span_price_cart_<?= $data[ 'orderItem_id' ] ?>"><?= number_format ( $price - $discount ) ?></span><span class="toman green" style="position:relative;top: 40%;">ریال</span>
                        </p>
                    </div>
                </div>
                <?php
...
$form               .= $this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'accountingStock/sendDeliver/sendDeliverSave',
        'id'     => 'orderOK'
    ),
        ) ) ;
...
$sendDeliver_status = array (
    'inventoryOk' => \f\ifm::t ( 'inventoryOk' ),
    'sending'     => \f\ifm::t ( 'sending' ),
    'delivery'    => \f\ifm::t ( 'delivery' ),
    'returned'    => \f\ifm::t ( 'returned' ),
        ) ;
foreach ( $sendDeliver_status AS $key => $value )
{
...
$form .= $this->formW->select ( array (
    'htmlOptions' => array (
        'id'       => 'status',
        'name'     => 'status',
        'onchange' => 'checkStatusDeliver()'
    ),
    'label'       => array (
        'text' => \f\ifm::t ( 'sendDeliver_status' ),
    ),
    'validation'  => array (
        'required' => ''
    ),
    'choices'     => $sendDeliver_status,
