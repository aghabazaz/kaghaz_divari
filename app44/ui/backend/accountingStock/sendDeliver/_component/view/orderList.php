...
<script>
    $(document).ready(function () {
        ...
        widgetHelper.makeDataTable('#myTable', newOption, '<?= \f\ifm::app ()->baseUrl ?>accountingStock/sendDeliver/sendDeliverList');
