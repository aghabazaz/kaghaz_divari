...
echo $pageWidget->renderTitle ( array ( 'title' => \f\ifm::t ( 'contact' ) ) ) ;
/* @var $boxWidget \f\w\box */
$boxWidget = \f\widgetFactory::make ( 'box' ) ;
echo $boxWidget->begin ( array ( 'type'  => 'table', 'title' => \f\ifm::t ( 'list' ) . \f\ifm::t ( 'contact' ) ) ) ;
...
<script>
    $(document).ready(function () {
        ...
        widgetHelper.makeDataTable('#myTable' , newOption , '<?= \f\ifm::app ()->baseUrl ?>cms/contact/contactList');
