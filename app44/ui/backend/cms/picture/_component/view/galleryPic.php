...
<div class="item col-lg-3 col-md-4 col-sm-6" id="pic<?=$params['id']?>" >
    <div class="thumbnail" style="border:2px dotted <?=$color?>;height:200px">
        <img alt="" src="<? echo \f\ifm::app()->fileBaseUrl.$params['id']?>" class="list-group-image" style="max-height:190px !important;vertical-align: middle">
        <div class="caption" style="background: #eee" >
            ...
            <ul class="list-unstyled" style="padding-bottom:10px;padding-right: 0px">
                <li style="color:silver;font-size:12px">حجم فایل : <?=  number_format(($params['size']/1024),1).' کیلوبایت'?></li>
            </ul>
            <div class="action-buttons" style="text-align:center">
                ...
                <a  style="color:darkred" data-toggle="confirmation" data-placement='top' data-on-confirm='widgetHelper.tt("ui", "shop.product.deletePic", {fileId: <?= $params[ 'id' ]?>,selector: "#pic <?= $params[ 'id' ]?>"}, "removePic" );' href="javascript:void(0)">
                    <i class="fa fa-trash-o" style="font-size:20px;text-decoration: none" data-toggle="tooltip" title="<?=  \f\ifm::t ('remove')?>"></i> 
                </a>
                <a  style="color:green" data-toggle="confirmation" data-placement='top' data-on-confirm='coverPic(<?= $params[ 'id' ]?>);' href="javascript:void(0)">
