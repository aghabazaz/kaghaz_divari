...
function loadFeature(item)
    ...
    {
       var oldCat = $('#oldCat').val();
      if(oldCat==null || oldCat=='null'){
          var strVal=$('#category').val();
          var typeCat=$('#category option[value="' + strVal + '"]').attr('data_id');
      }else{
...
<div class="modal fade" id="catNotSelectDialog" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= "مشخصات فنی و نوع دسته بندی بایستی با اولین دسته بندی انتخاب شده منطبق باشد!" ?>
            </div>
