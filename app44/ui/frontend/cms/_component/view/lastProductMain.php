<div class="teaser_content media">
    <div style="width:100%;text-align:center;direction: rtl">
        ...
        <h3 style="font-size:22px;color:#FFF">
            <i class="fa fa-gift"></i> آخرین محصولات ثبت شده
        </h3>
                    ...
                    <div  class="testimonials-carousel" style="padding:0px">
                        <div style="direction: rtl">
                            <a class="pull-right "  style="padding-left:10px">
                                <img class="media-object" src="<?= \f\ifm::app ()->fileBaseUrl.$data['picture'] ?>" title="<?= $data['title'] ?>" alt="<?= $data['title'] ?>">
                            </a>
                            <div class="pull-right">
                                <h4>
                                    <a href="<?=  \f\ifm::app ()->siteUrl.'productDetail/'.$data['id']?>" style="color:#fff;">
                                        <?= $data['title'] ?>
                                    </a>
