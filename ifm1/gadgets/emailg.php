...
class emailg
{
    ...
    public function mailAttachments ( $to, $from, $subject, $message,
                               $attachments = array ( ) ,
                               $headers = array ( ) ,
                               $additional_parameters = '' )
    {
        ...
        // Send the e-mail.
         $result  = mail ( $to, $subject, $message_string, $headers_string,
                      $additional_parameters ) ;
    }

    public function send ( $email, $from, $message, $subject )
    {
