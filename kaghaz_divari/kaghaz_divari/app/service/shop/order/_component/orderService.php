                ...
                if ( is_array( $result ) != NULL )
                {
                    ...
                    if($params['typeOpr']=='decrease') {
                     ...
                     /*   \f\pr($params);
                        ...
                        \f\pre($checkStock['stock']);
*/
                        if((($params['typeOpr']=='increase' or $params['typeOpr']=='addToCart') and $params['count']<$checkStock['stock']) or !isset($params['typeOpr'])){
                          // \f\pre('hi');
                            $resultOrderItem= \f\ttt::dal('shop.orderItem.addOrderItemCountAndMulPrice',
                                [
                                    'id' => $result['id'],
