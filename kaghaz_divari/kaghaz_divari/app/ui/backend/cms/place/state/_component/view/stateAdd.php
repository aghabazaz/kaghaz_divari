...
echo $this->pageTitleW->renderTitle ( array (
    ...
    'links' => array (
        array (
            'title' => \f\ifm::t ( 'listState' ),
            'href'  => \f\ifm::app ()->baseUrl . 'cms/place/state/index' ) ) ) ) ;
...
$form.=$this->formW->begin ( array (
    'htmlOptions' => array (
        'method' => 'post',
        'action' => \f\ifm::app ()->baseUrl . 'cms/place/state/stateSave',
        'id'     => 'stateAdd'
    ),
        ) ) ;
...
<script>
    ...
    widgetHelper.formSubmit('#stateAdd');
</script>
