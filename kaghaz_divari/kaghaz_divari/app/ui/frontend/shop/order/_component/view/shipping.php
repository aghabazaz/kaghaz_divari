    ...
    <div class="container grid-row section-mainDetail div-line-height" >
        ...
        <div class="col-md-12">
            <h2 class="title2 right" style="margin-top:0px">
                <i class="icon icon-caret-left-blue"></i>&nbsp;آدرس شما ( در صورت کامل نبودن لطفا اطلاعات خود را ویرایش کنید )
            </h2>
        ...
        <div class="shipping" >
            <div class="col-md-12 container-cart">
                <div class="col-md-1  padding-0-col">
                    <div class="tbody-2 border" style="cursor: pointer;">
                        <div class="pd" >
                            <span class="active-address">
                                <i class="fa fa-check"></i>
                            </span>
                            <div class="radio-control" >
                                <input id="rChoiseAddress[]"  type="radio" name="rChoiseAddress[]" value="<?= $member[ 0 ][ 'id' ] ?>" checked="">
                ...
                <div class="col-md-10  padding-0-col">
                    <div class="col-md-12 padding-0-col">
                        <div class="tbody border">
                            <div class="pd ">
                                <p style="text-align:right;height:20px"><?= $member[ 0 ][ 'name' ] ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7 padding-0-col">
                        <div class="tbody-3 border">
                            <div class="pd " >
                                <span class="fa-digit" > <?= $member[ 0 ][ 'address' ] ?> </span>
<input type="hidden" id="address" name="address" value="<?=$member[ 0 ][ 'address' ]?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 padding-0-col row-2" style="padding-right:0px !important;">
                        <div class="tbody border">
                            <div class="pd ">
                                <span >شماره تماس اضطراری: <span class="left  fa-digit">  <?= $member[ 0 ][ 'mobile' ] ?>  </span></span>

                            </div>
                        </div>
                        <div class="tbody border">
                            <div class="pd ">
                                <span >شماره تماس ثابت: <span class="left  fa-digit">   <?= $member[ 0 ][ 'phone' ] ?> </span></span>
                ...
                <div class="col-md-1  padding-0-col">
                    <div class="tbody-2 border">
                        <div class="pd last" style="background: #fff;height:90px">
                            <a id="btnDelete_0" class="delete" href="<?= \f\ifm::app ()->siteUrl ?>additionalinfo"  style="height: 149px;position:relative;top: 45%;">
        ...
        <div class="col-md-12">
            <h2 class="title2 right" style="margin-top:30px"><i class="icon icon-caret-left-blue"></i>&nbsp;زمان تحویل کالا</h2>
            <div class="clearfix"></div>
        </div>
        <div class="shipping" >
            <?php
            ...
            {
              $data['scope_time']=json_decode($data['scope_time']);
                if ( $data[ 'id' ] == $transId )
                {
                    $checked = 'checked' ;
                }
               ...
               <?php
                for($i=0;$i<=$data['scope_day'];$i++) {
                    ?>
                    <div class="col-md-12 container-cart way-send-product">
                        <div class="col-md-2  padding-0-col">
                            <div class="tbody border way-send-product-tbody  send-radio-type" style="cursor: pointer;">
                                <div class="pd">
                                    <div class="radio-control">
                                        <input id="rbTransport_<?= $data['id'].$i ?>" type="radio" name="transports"
                                               value="<?= $data['id'] ?>" checked >
                                        <label for="rbTransport_<?= $data['id'].$i ?>"
                                               style="position:relative ;top: 50%;"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8  padding-0-col">
                            <div class="tbody border way-send-product-tbody">
                                <div class="pd send-type-box">
                                    <i class="icon fa fa-calendar-o fa-5x"
                                       style="margin: 0px 25px 0 0;float: right;font-size: 35px;color:#6BBDE9"></i>
                                    <div class="raysan">
                                        <?php
                                        $timeToday=time();
                                        $this->registerGadgets(array('dateG'=>'date'));
                                        $k = time() + ($i * (24 * 60 * 60));
                                        $mDate2 = $this->dateG->dateTime($k, 2);
                                        ?>
                                        <p class="title2 fa-digit" style="margin: 0;" id="<?= $data['id'].$i ?>"><?= $mDate2;?></p>
                                        <i class="icon fa fa-clock-o fa-5x"
                                           style="margin: 0px 25px 0 0;float: right;font-size: 35px;color:#6BBDE9"></i>
                                        <select class="select-detail select-color" id="<?= $data['id'].$i ?>">
                                            <?php
                                            foreach ( $data['scope_time'] AS $item )
                                            {
                                                ?>
            ...
            <div class="addtocart">
                <div class="foot">
                    <div class="btn-foot" >
                        ...
                        <div class="left  setting-text-left">
                            <div class="raysan-button-container-cart hasIcon step_forward " style="top: 0;width: 200px;">
...
<main class="mobile-view rtl" style="margin-top:10px">
            ...
            <div class="steps">
                <div class="rounded_rectangle">
                    ...
                    <span id="ctl12_Progressbar_lblBullet_2" class="bullet or green">
                        <span class="spacer first"></span>
                        <a href="/shipping" id="ctl12_Progressbar_lblTitle_2" class="s_title green" data-url="/Shipping">ارسال</a>
                        <span class="spacer second"></span>
                    </span>
                    <span id="ctl12_Progressbar_lblBullet_3" class="bullet pi ">
                        <span class="spacer first"></span>
                        <a href="/review" id="ctl12_Progressbar_lblTitle_3" class="s_title" data-url="/review">بازبینی</a>
                        <span class="spacer second"></span>
                    </span>
    ...
    <div style="background:#ddd;padding: 5px;color:#000;margin: 10px 0px">
        <div><i class="fa fa-truck"></i> زمان تحویل ارسال</div>
    </div>
    <?php
    $count=count($transports);
    $heightDiv=$count*200;
    ?>
    <div class="shipping" style="height:<?=$heightDiv?>px">
        <?php
        ...
        foreach ( $transports AS $data )
        {
            ...
            for($i=0;$i<=$data['scope_day'];$i++) {
                ?>
                <div class="col-xs-12 container-cart way-send-product">
                    <div class="col-xs-2  padding-0-col">
                        <div class="tbody border way-send-product-tbody  send-radio-type" style="cursor: pointer;">
                            <div class="pd">
                                <div class="radio-control">
                                    <input id="rbTransport_<?= $data['id'].$i ?>" type="radio" name="transports"
                    ...
                    <div class="col-xs-8  padding-0-col">
                        <div class="tbody border way-send-product-tbody">
                            <div class="pd send-type-box">
    ...
    <div onclick="redirectToReview()"  style="z-index:999;position:fixed;bottom: 0px;right: 0px;text-align: center;height: 40px;line-height: 40px;width: 100%;background: #3BB153;color:#fff;cursor: pointer;font-size: 15px">
        ثبت و بازبینی سفارش
...
<script>
    ...
    function redirectToReview() {
        var fullIdTransparentPro=$("input[name='transports']:checked").attr('id');
           var idTransparentPro = fullIdTransparentPro.substr(fullIdTransparentPro.indexOf("_") + 1);
           var option = {
               transportation_id: $("input[name='transports']").val(),
               id:<?= $orderId ?>,
               address: $("#address").val(),
               date_delivery: $("p#" + idTransparentPro).text(),
               time_delivery: $("select#" + idTransparentPro + "  option:selected").text()
           };
    ...
    function goPageReview(params)
    {
        ...
        } else if(params.result == 'errorAddress'){
            setTimeout(function () {
                widgetHelper.errorDialog('جهت ادامه مراحل خرید وارد کردن آدرس الزامی است. لطفا به پروفایل کاربری مراجعه فرمایید.');
                widgetHelper.closeDialog('errorDialog');
            }, 800);
        }else if(params.result == 'error'){
            setTimeout(function () {
                widgetHelper.errorDialog('لطفا یک زمان جهت تحویل کالا انتخاب کنید');
                widgetHelper.closeDialog('errorDialog');
            }, 800);
