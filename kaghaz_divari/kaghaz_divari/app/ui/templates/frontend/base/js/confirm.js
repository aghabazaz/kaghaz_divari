...
(function ($) {
  ...
  var Confirmation = function (element, options) {
      ...
      //alert($('body').find('[data-toggle="confirmation"]').attr('onclick'));
  ...
  Confirmation.prototype.getOnConfirm = function() {
      //eval(this.$element.attr('data-onclick'));
    if (this.$element.attr('data-on-confirm')) {
      this.$element.confirmation('hide');  
      eval(this.$element.attr('data-on-confirm'));
    }
    else {
