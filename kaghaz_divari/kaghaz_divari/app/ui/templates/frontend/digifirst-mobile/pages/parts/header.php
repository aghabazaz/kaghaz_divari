...
<script>
  ...
  gtag('config', 'UA-111210117-1');
    ...
    <link rel="stylesheet" type="text/css"
          href="<?= \f\ifm::app ()->siteUrl ?>app/ui/templates/frontend/digifirst-mobile/css/global.css">
    <link rel="stylesheet" type="text/css"
          href="<?= \f\ifm::app ()->siteUrl ?>app/ui/templates/frontend/digifirst-mobile/css/theme.765935.rtl.css">
    ...
    <div class="desktop-view">
        ...
        <section class="bottom_header">
            <div class="grid-row" style="margin:0px auto;position: relative">
                <?php
                echo \f\ttt::block( 'cms.menu.indexOld',
                    [
                        'name' => 'headerold'
                    ] );
                ?>
